...
public class InitializationGUI extends JFrame
{
    ...
    public static void main (String[] args)
    {
        ...
        loadingScreen.setLocation (screenDimensions.width/2 - loadingScreen.getSize().width/2, screenDimensions.height/2 - loadingScreen.getSize().height/2);
